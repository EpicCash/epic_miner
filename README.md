...
- The requirements for building the miner are the same from the epic server. You can check them in the topic [Requirements](https://github.com/EpicCash/epic/blob/master/doc/build.md#requirements) in the Epic server build instructions
...
```sh
git clone https://github.com/EpicCash/epic-miner
cd epic-miner
...
- Instruction of how to run the **epic server** and the **epic wallet** (in listening mode) using the .deb packages can be found [here](https://github.com/EpicCash/epic/blob/master/doc/running.org).
- If you want to build the **epic server** from source code, instructions can be found [here](https://github.com/EpicCash/epic/blob/master/doc/build.md).
- If you want to build and execute **epic wallet** (in listening mode) from source code, instructions can be found [here](https://github.com/EpicCash/epicwallet/tree/master/doc/build.md).

- To enable the stratum server in the epic server, we need to edit the server configuration file called `epic-server.toml`. If you are using the [epic server default configutation](https://github.com/EpicCash/epic/blob/master/doc/running.org#run_config_default), this file is under your home directory in the folder `~/.epic/main`. Open this file with your text editor and find the following line:
    ...
    More information about this can be found on the topic [Configuring the Epic Server to work with the miner](https://github.com/EpicCash/epic/blob/develop/doc/running.org#config_miner_server) in the testnet documentation.
...
options, and should be the first point of reference. Also, you can see Topic [Configuring your epic-miner](https://github.com/EpicCash/epic/blob/develop/doc/running.org#config_miner) in the testnet documentation for further information.
